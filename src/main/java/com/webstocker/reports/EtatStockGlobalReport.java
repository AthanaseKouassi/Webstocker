...
public class EtatStockGlobalReport {
    ...
    private class SubreportExpression extends AbstractSimpleExpression<JasperReportBuilder> {
        ...
        public JasperReportBuilder evaluate(ReportParameters reportParameters) {
            ...
            TextColumnBuilder<Long> quantiteGlobalEnStock = col.column("stock" , "quantiteGlobalEnStock", type.longType());//.setFixedWidth(200);//.setPrintRepeatedDetailValues(false);
            ...
            TextColumnBuilder<Long> qtePerteColumn = col.column("Quantité perte" , "quantitePerte", type.longType());//.setFixedWidth(200);//.setPrintRepeatedDetailValues(false);
        
            report
                .columns(productColumn,quantiteVendueColumn, arrivageColumn,qtePromoColumn,qteTransfertColumn, qtePerteColumn,quantiteGlobalEnStock)
